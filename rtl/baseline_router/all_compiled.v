...
module bsg_mesh_router_decoder_dor (
	...
	assign req[sv2v_cast_3((3'd0 + 1) + 2)] = x_eq & y_lt;
	assign req[sv2v_cast_3((3'd0 + 1) + 3)] = x_eq & y_gt;
	assign req[sv2v_cast_3(3'd0 + 1)] = ~x_eq & x_lt;
	assign req[sv2v_cast_3((3'd0 + 1) + 1)] = ~x_eq & x_gt;
	generate
		if (debug_p) begin : genblk1
			always @(negedge clk_i)
				if (~reset_i)
