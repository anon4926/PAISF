...
**PAISF: A _Partially Adaptive In-Order Selection Function for On-Chip Routing_**

and contains all code and data required to reproduce the reported results.

### Reproducing Experimental Results

To reproduce all evaluation results, run:
```bash
cd booksim2/src
make
cd ../../
...
### Hardware Realizability Results

RTL implementations of the baseline, ISF and PAISF routers as well as the resulting reports can be found in the `rtl` directory.
